...
export class Router {
    ...
    private userNameElement: NodeListOf<HTMLElement> | null;
    private routes: RouteType[];
    private currentStyles: HTMLLinkElement[];
    private balanceShowElement: NodeListOf<HTMLElement> | null;

    constructor() {
        this.contentPageElement = document.getElementById('content');
        this.titleElement = document.getElementById('titlePage');
        this.userNameElement = null;
        this.balanceShowElement = null;
        ...
        try {
            ...
            if (result) {
                if (this.balanceShowElement) {
                    this.balanceShowElement.forEach((el: HTMLElement) => {
                        el.innerText = (result as BalanceType).balance.toString()
                    });
                }
            }
